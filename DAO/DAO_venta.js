    ...
    async create_venta(productos = []){
        ...
        try{
            ...
            for(let producto of productos){
                ...
                let galleta_data = await galleta.model.findOne({where: {id_galleta: producto.id_galleta}}, {transaction: transaction});
            ...
            for(let producto of productos){
                await detalle_venta.model.create({id_galleta_fk: producto.id_galleta, id_venta_fk: created_venta.id_venta, tipo_unidad: producto.tipo_unidad, cantidad: producto.cantidad}, {transaction: transaction});
            }
            console.log(total);
            transaction.commit();
